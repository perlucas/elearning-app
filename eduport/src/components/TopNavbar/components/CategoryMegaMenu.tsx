    ...
    <li className="dropdown-submenu dropend">
      ...
      <div className="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
        <Row className="p-4">
          <Col xl={6} xxl={4} className="mb-4 mb-xl-0">
            ...
            <ul className="list-unstyled">
              {CategoryMegaMenuData.getStarted.map((item, idx) => (
                <li key={idx}>
          ...
          <Col xl={6} xxl={4} className="mb-4 mb-xl-0">
            ...
            <hr />
            {CategoryMegaMenuData.degree.map((degree, idx) => (
        ...
        <Row>
          <Col xs={12}>
            <Card
              className="bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden"
