...
export const features: FeatureType[] = [
  {
    ...
    icon: (
      <svg className="fill-primary" width="63.28px" height="47.41px" viewBox="0 0 63.28 47.41">
  ...
  },
  {
    ...
    icon: (
      <svg className="fill-orange" width="54.22px" height="58.19px" viewBox="0 0 54.22 58.19">
  ...
  },
  {
    ...
    icon: (
      <svg className="fill-purple" width="54.22px" height="52.86px" viewBox="0 0 54.22 52.86">
  ...
  },
  {
    ...
    icon: (
      <svg className="fill-warning" width="60.77px" height="52.15px" viewBox="0 0 60.77 52.15">
  ...
  },
  {
    ...
    description: 'Go he prisoners And mountains in just switching city steps Might.',
    icon: (
      <svg className="fill-success" width="55.44px" height="52.15px" viewBox="0 0 55.44 52.15">
