...
const Hero = () => {
  return (
    <section className="position-relative pb-0 pb-md-5 overflow-hidden">
      <figure className="position-absolute  top-50 end-0 translate-middle-y me-n8 d-none d-sm-block">
        <svg className="fill-success opacity-1" width="634.1px" height="776px">
          <path
            d="M161.4,200.8c-9,40.1-7.5,82.5-20.8,121.6c-17.5,52.8-58.5,93.8-92,138.1c-33,44.8-59.9,101.8-42.5,154.6
