          ...
          <Col xs={12}>
            <div className="tiny-slider arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
              <TinySlider settings={courseSliderSettings} className="tiny-slider-inner">
                <Card
                  className="overflow-hidden h-500px h-md-600px text-center rounded-0"
                  style={{ backgroundImage: `url(${backgroundImg1})`, backgroundPosition: 'center left', backgroundSize: 'cover' }}>
                ...
                <Card
                  className="overflow-hidden h-500px h-md-600px text-center rounded-0"
                  style={{ backgroundImage: `url(${backgroundImg2})`, backgroundPosition: 'center left', backgroundSize: 'cover' }}>
                  <div className="bg-overlay bg-dark opacity-6" />
